...
BASE_STRUCT_SCHEMA = BASE_COMPONENT_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_COUNT, default=0): cv.positive_int,
...
NUMBER_SCHEMA = vol.All(
    BASE_STRUCT_SCHEMA.extend({
        ...
        # vol.Required(CONF_MIN_VALUE): vol.Coerce(float),
        # vol.Required(CONF_MAX_VALUE): vol.Coerce(float),
...
MODBUS_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_TIMEOUT, default=5): cv.socket_timeout,
        ...
        vol.Optional(CONF_SENSORS): vol.All(
            ...
            cv.ensure_list, [vol.All(SENSOR_SCHEMA)]
        ),
